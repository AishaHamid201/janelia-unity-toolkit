...
public class TalkToNiDaq_LED_Loom : MonoBehaviour
{
    ...
    private void Start()
    {
        if (loomTexture == null)
        {
            loomTexture = FindObjectOfType<AnimateCylinderTextureLoom>();
            if (loomTexture == null)
            {
                Debug.LogError("TalkToNiDaq_LED_Loom: No AnimateCylinderTextureLoom found in scene.");
                return;
            }
        }
